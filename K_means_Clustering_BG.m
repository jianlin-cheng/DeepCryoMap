function [cluster_image] = K_means_Clustering_BG(img)
...
%     Total_White_Pixels5 = nnz(Ckm5);
    ...
    if (Total_White_Pixels1<Total_White_Pixels2) & (Total_White_Pixels1<Total_White_Pixels3) 
        cluster_image=Ckm1;
    elseif  (Total_White_Pixels2<Total_White_Pixels1) & (Total_White_Pixels2<Total_White_Pixels3)
        cluster_image=Ckm2;
    elseif  (Total_White_Pixels3<Total_White_Pixels1) & (Total_White_Pixels3<Total_White_Pixels2)
        cluster_image=Ckm3;
    elseif  (Total_White_Pixels3<Total_White_Pixels1) & (Total_White_Pixels3<Total_White_Pixels2)
        cluster_image=Ckm4;
%     else
