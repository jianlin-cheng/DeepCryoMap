...
Particles_images='C:\Users\Adil Al-Azzawi\Desktop\Particle Alignement\Particles Images\Pre-processed\Top_view';
...
%         figure; imshowpair(cluster_1,cluster3,'montage'); title('Orginal Clustered (Binary Mask) Vs. preprocessed Particle Image ')
        ...
        blurryImage = conv2(single(CH1), kernel, 'same');
        CH1 = blurryImage > 0.5; % Rethreshold
